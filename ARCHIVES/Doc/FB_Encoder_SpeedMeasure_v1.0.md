...
> Source code : `CODE/E_CODEURS/FB_Encoder_SpeedMeasure.st` · instances `instEncoderSpeedMeasureM1/M2` dans `PRG_02_Acquisition`.  
...
## 2. Interface (vérifiée `CODE/E_CODEURS/FB_Encoder_SpeedMeasure.st`)
