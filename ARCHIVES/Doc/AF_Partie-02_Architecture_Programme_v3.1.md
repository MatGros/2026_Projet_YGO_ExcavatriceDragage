...
| <nobr><code>TC-P02-003</code></nobr> | Sorties physiques via `PRG_06_Outputs` | Aucun autre POU n'écrit les Q/PDO finaux | `💻 AUTO` | <small>§2</small> |
| <nobr><code>TC-P02-004</code></nobr> | Ordre d'exécution MainTask conforme | Tâche CODESYS + `G200_check_linkage.py` PASS | `💻 AUTO` | <small>§4</small> |
