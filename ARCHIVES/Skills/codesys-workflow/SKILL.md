...
Dès que la skill est déclenchée, **afficher immédiatement** ce bandeau avant toute autre action :

```
============================================================
🏗️ WORKFLOW CODESYS / CODESYS-WORKFLOW ACTIF
============================================================
```

Puis annoncer en 1 ligne la cible (ex. « Modification de FB_Winch (C2, TREUILS) »).
