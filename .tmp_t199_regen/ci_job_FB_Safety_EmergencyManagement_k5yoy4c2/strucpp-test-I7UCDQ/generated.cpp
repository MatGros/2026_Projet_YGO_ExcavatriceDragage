...
void FB_SAFETY_EMERGENCYMANAGEMENT::operator()() {
    ...
    if (ENABLE) {
        ...
        switch (ARMINGSEQSTEP) {
            ...
            default:
                ...
                EMERGENCYARMINGLOCKOUTACTIVE = true;
                LASTABORTSTEP = ARMINGSEQSTEP;
                LASTABORTCAUSE = TO_WORD(CST_ABORT_INVALID_STEP);
                ARMINGSEQSTEP = CST_STEP_IDLE;
                break;
        }
    ...
    if (!ENABLE) {
        ...
        if (LASTABORTCAUSE == TO_WORD(CST_ABORT_INVALID_STEP)) {
            STATUS.OPERATORMESSAGE = "AU: etape sequence invalide - verifier puis Reset";
        } else {
