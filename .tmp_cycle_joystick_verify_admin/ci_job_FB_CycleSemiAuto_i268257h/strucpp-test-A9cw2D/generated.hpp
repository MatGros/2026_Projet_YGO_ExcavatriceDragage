...
enum class E_AUTOCYCLESTEP { AX0_REPOS = 0, AX1_INIT = 1, AX2_TRANSLATE_P1 = 2, AX3_OPEN_BUCKET = 3, AX4_DESCEND_DIVING = 4, AX5_KOBOLD_INIT = 5, AX6_SEARCH_IMMERSION = 6, AX7_SEARCH_BOTTOM = 7, AX8_BOTTOM_CONFIRMED = 8, AX9_RAISE_OFF_BOTTOM = 9, AX10_CLOSE_BUCKET = 10, AX11_CTRL_ASCENT = 11, AX12_LOADED_ASCENT = 12, AX13_DRAIN_PAUSE = 13, AX14_TRANSLATE_DUMP = 14, AX15A_DUMP_ARRIVE = 15, AX15B_DUMP_OPEN = 16, AX15C_DUMP_REPOSITION = 17, AX18_DONE_SYNC = 18, AX_STAB = 19, AX_DIVING_RETRY = 20 };
...
public:
    ...
    IEC_TIME CST_BUCKETOPENSTABTIME;
