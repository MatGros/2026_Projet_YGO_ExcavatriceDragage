...
enum class E_STATE { DISABLED = 0, INIT = 1, READY = 2, BUSY = 3, DONE = 4, STOPPING = 5, ERROR = 6 };
...
enum class E_AUTOCYCLESTEP { AX0_REPOS = 0, AX1_INIT = 1, AX2_TRANSLATE_P1 = 2, AX3_OPEN_BUCKET = 3, AX4_DESCEND_DIVING = 4, AX5_KOBOLD_INIT = 5, AX6_SEARCH_IMMERSION = 6, AX7_SEARCH_BOTTOM = 7, AX8_BOTTOM_CONFIRMED = 8, AX9_RAISE_OFF_BOTTOM = 9, AX10_CLOSE_BUCKET = 10, AX11_CTRL_ASCENT = 11, AX12_LOADED_ASCENT = 12, AX13_DRAIN_PAUSE = 13, AX14_TRANSLATE_DUMP = 14, AX15A_DUMP_ARRIVE = 15, AX15B_DUMP_OPEN = 16, AX15C_DUMP_REPOSITION = 17, AX18_DONE_SYNC = 18, AX_STAB = 19, AX_DIVING_RETRY = 20, AX3_WAIT_DIVE_START = 21 };

using IEC_E_AUTOCYCLESTEP = IEC_ENUM<E_AUTOCYCLESTEP>;
...
public:
    ...
    IEC_BOOL KOBOLDCONTACTORFEEDBACK;
    ...
    IEC_BOOL M1_SPEEDVALID;
    IEC_BOOL M2_SPEEDVALID;
    IEC_BOOL M1_CONTACTORSRELEASED;
    IEC_BOOL M2_CONTACTORSRELEASED;
    IEC_BOOL M1_BRAKEAPPLIED;
    IEC_BOOL M2_BRAKEAPPLIED;
    ...
    IEC_BOOL INITPOSITIONOK;
    IEC_BOOL WINCHESATTOPWINDOW;
    IEC_TIME CFGDRAINTIME;
    IEC_BOOL SKIPDRAINREQUEST;
    IEC_BOOL REPOSITIONREQUEST;
    IEC_BOOL CFGCOMMISSIONINGENABLE;
    IEC_INT CFGFORCESTEPTARGET;
    IEC_BOOL CFGFORCESTEPAPPLY;
    IEC_REAL DIVESTARTMINM;
    IEC_REAL CFGRAISEOFFBOTTOMM;
    IEC_INT CFGCTRLASCENTMAXSTEP;
    IEC_INT M1_SPEEDSTEPAPPLIED;
    IEC_INT M2_SPEEDSTEPAPPLIED;
    // Outputs
    IEC_BOOL READY;
    ST_FAULT FAULT;
    ...
    IEC_BOOL BOTTOMTOUCHED;
    ST_PROGRAMWINCHREQUEST WINCHM1CMD;
    ST_PROGRAMWINCHREQUEST WINCHM2CMD;
    ST_PROGRAMTRANSLATIONREQUEST TRANSLATIONCMD;
    ST_PROGRAMBUCKETREQUEST BUCKETCMD;
    IEC_E_AUTOCYCLESTEP CYCLESTEP;
    IECStringVar<80> CYCLESTATESTR;
    IEC_E_AUTOCYCLESTEP CYCLESTEPATERROR;
    ...
    IEC_TIME CURRENTCYCLEELAPSED;
    IEC_TIME LASTCYCLEDURATION;
    // In-Out
    IEC_INT SAMPLECOUNT;
    // Local variables
    R_TRIG RESETEDGE;
    ...
    R_TRIG ABORTEDGE;
    R_TRIG ERROREDGE;
    R_TRIG JOYDEFLECTEDEDGE;
    R_TRIG FORCESTEPAPPLYEDGE;
    IEC_BOOL CYCLEMOTIONPERMIT;
    IEC_BOOL WINCHESATDIVESTEP;
    IEC_BOOL SAMPLECOUNTDONE;
    IEC_E_AUTOCYCLESTEP STATE;
    IEC_E_AUTOCYCLESTEP SAVEDSTATE;
    IEC_E_AUTOCYCLESTEP PAUSEDSTATE;
    IEC_BOOL WAITINGRESUME;
    IEC_REAL TOUCHPOSITIONM;
    IEC_REAL RAISETARGETM;
    IEC_INT SELECTEDWORKTARGET;
    IEC_BOOL INITCONDITIONSOK;
    IEC_E_AUTOCYCLESTEP STEPMAXPREVSTATE;
    R_TRIG KOBOLDRISEEDGE;
    F_TRIG KOBOLDFALLEDGE;
    TON KOBOLDINITTIMER;
    TON KOBOLDSTABTIMER;
    TON BOTTOMTOUCHSTABTIMER;
    TON RETRYJOYRELEASETIMER;
    TON PALIERNOT4TIMER;
    IEC_BOOL DIVINGRETRYTRIG;
    IEC_INT CTRLASCENTMAXSTEPEFF;
    IEC_REAL RAISEOFFBOTTOMEFF;
    IEC_REAL DIVESTARTMINEFF;
    TON DRAININGTIMER;
    TON CYCLERUNTIMER;
    R_TRIG SKIPDRAINEDGE;
    IEC_TIME DRAINTIMEEFF;
    ...
    TON DIVESTARTSTOPTIMER;
    TON DIVESTARTTIMEOUTTIMER;
    IEC_BOOL DIVESTARTSTOPPED;
    IEC_TIME CST_KOBOLDSTABTIME;
    IEC_TIME CST_BOTTOMTOUCHSTABTIME;
    FB_FAULTCORE INSTFAULT;
    Array1D<ST_FAULTCAUSE, 0, 15> INSTCAUSES;
    // Local variables
    IEC_INT CST_STEPSLOW;
    IEC_INT CST_STEPDIVE;
    IEC_INT CST_STEPLOADED;
    IEC_TIME CST_KOBOLDINITTIMEOUT;
    IEC_TIME CST_DIVESTARTSTOPCONFIRMTIME;
    IEC_TIME CST_DIVESTARTSTOPTIMEOUT;
    IEC_REAL CST_DIVESTARTSPEEDTHRESHOLDMPS;
    IEC_REAL CST_RAISEOFFBOTTOMDEFAULTM;
    IEC_REAL CST_COUPLEDPOSBACKLASHM;
    ...
    virtual ~FB_CYCLESEMIAUTO() = default;
