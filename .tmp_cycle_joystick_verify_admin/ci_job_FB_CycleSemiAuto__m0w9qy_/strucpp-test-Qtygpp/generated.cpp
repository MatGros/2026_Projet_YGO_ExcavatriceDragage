...
void FB_CYCLESEMIAUTO::operator()() {
    ...
    KOBOLDSTABTIMER.IN = (((STATE == E_AUTOCYCLESTEP::AX6_SEARCH_IMMERSION)) & (JOYSTICKDEFLECTED)) & (KOBOLDIMMERSED);
    ...
    RETRYJOYRELEASETIMER.IN = (((((STATE == E_AUTOCYCLESTEP::AX5_KOBOLD_INIT)) | ((STATE == E_AUTOCYCLESTEP::AX6_SEARCH_IMMERSION))) | ((STATE == E_AUTOCYCLESTEP::AX7_SEARCH_BOTTOM)))) & (!JOYSTICKDEFLECTED);
    ...
    if (!WAITINGRESUME) {
        switch (STATE) {
            ...
            case E_AUTOCYCLESTEP::AX5_KOBOLD_INIT:
                ...
                if ((JOYSTICKDEFLECTED) & (KOBOLDCONTACTORFEEDBACK)) {
                    STATE = E_AUTOCYCLESTEP::AX6_SEARCH_IMMERSION;
                }
                break;
            case E_AUTOCYCLESTEP::AX6_SEARCH_IMMERSION:
                ...
                WINCHM2CMD.STEPTGT = CST_STEPDIVE;
                BUCKETCMD.REQKOBOLDMEASUREENABLE = CYCLEMOTIONPERMIT;
                if ((JOYSTICKDEFLECTED) & (KOBOLDSTABTIMER.Q)) {
                    STATE = E_AUTOCYCLESTEP::AX7_SEARCH_BOTTOM;
                }
                break;
            case E_AUTOCYCLESTEP::AX7_SEARCH_BOTTOM:
                ...
                WINCHM2CMD.STEPTGT = CST_STEPDIVE;
                BUCKETCMD.REQKOBOLDMEASUREENABLE = CYCLEMOTIONPERMIT;
                if ((JOYSTICKDEFLECTED) & (((KOBOLDFALLEDGE.Q) | (!KOBOLDIMMERSED)))) {
