...
USER_ID="${IMMORTERM_PROJECT_ID:-matgros-2026_projet_ygo_excavatricedragage}"
...
context = '<immorterm-memory project=\"' + os.environ.get('_IM_USER', 'matgros-2026_projet_ygo_excavatricedragage') + '\">' + '\n'
