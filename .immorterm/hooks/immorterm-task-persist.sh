...
# Project: matgros-2026_projet_ygo_excavatricedragage
#
...
RESULT=$(IMMORTERM_PROJECT_ID="${IMMORTERM_PROJECT_ID:-matgros-2026_projet_ygo_excavatricedragage}" _HOOK_INPUT="$STDIN_DATA" python3 - <<'PYEOF' 2>>"$ERR_FILE"
...
project_id = os.environ.get("IMMORTERM_PROJECT_ID", "matgros-2026_projet_ygo_excavatricedragage")
