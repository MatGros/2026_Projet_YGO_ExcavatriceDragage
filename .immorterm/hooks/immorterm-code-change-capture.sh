...
PARSED=$(IMMORTERM_PROJECT_ID="${IMMORTERM_PROJECT_ID:-matgros-2026_projet_ygo_excavatricedragage}" _IM_IID="$IMMORTERM_ID" _HOOK_INPUT="$STDIN_DATA" python3 - <<'PYEOF' 2>>"$ERR_FILE"
