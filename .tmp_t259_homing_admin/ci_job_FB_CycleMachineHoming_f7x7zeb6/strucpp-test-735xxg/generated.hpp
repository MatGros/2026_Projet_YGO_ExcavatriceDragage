...
enum class E_MACHINEHOMINGSTEP { IDLE = 0, LOSS_SAFESTOP = 5, BOTH_NOT_HOMED = 10, M1_NOT_HOMED = 11, M2_NOT_HOMED = 12, OFFSET_UNKNOWN = 20, NEED_TOP_POSITION = 30, NEED_MECHANICAL_STOP = 40, AWAIT_BUCKET_CONFIRM = 45, HOMING_IN_PROGRESS = 50, VALID = 60, FAILED = 70 };

using IEC_E_MACHINEHOMINGSTEP = IEC_ENUM<E_MACHINEHOMINGSTEP>;

enum class E_MACHINEHOMINGTXSTATE { HX0_REPOS = 0, HX1_CHOICE = 1, HX2_CLIMB = 2, HX2N_NEUTRAL = 3, HX3_HOME_AXES = 4, HX3N_PAUSE = 5, HX4_BUCKET_ADJUST = 6, HX5_BUCKET_COMMIT = 7, HX6_HOMED = 8, HXF_FAILED = 9 };

using IEC_E_MACHINEHOMINGTXSTATE = IEC_ENUM<E_MACHINEHOMINGTXSTATE>;

struct ST_FBMACHINEHOMINGCYCLE_AXISHOMINGSTATUS {
...
using IEC_ST_FBMACHINEHOMINGCYCLE_AXISHOMINGSTATUS = ST_FBMACHINEHOMINGCYCLE_AXISHOMINGSTATUS;

struct ST_FBMACHINEHOMINGCYCLE_HOMINGDEMAND {
    IEC_BOOL HOMEREQ{};
    IEC_BOOL USEDYNAMICTARGET{};
    IEC_REAL DYNAMICTARGET_M{};
};

using IEC_ST_FBMACHINEHOMINGCYCLE_HOMINGDEMAND = ST_FBMACHINEHOMINGCYCLE_HOMINGDEMAND;

struct ST_FBMACHINEHOMINGCYCLE_BUCKETCOMMIT {
    IEC_BOOL COMMITOPEN{};
    IEC_BOOL COMMITCLOSE{};
};

using IEC_ST_FBMACHINEHOMINGCYCLE_BUCKETCOMMIT = ST_FBMACHINEHOMINGCYCLE_BUCKETCOMMIT;

struct ST_FBMACHINEHOMINGCYCLE_CFG {
    IEC_REAL CFGTOPHOMINGTARGET_M{};
    IEC_REAL CFGOFFSETOPEN_M{};
    IEC_REAL CFGOFFSETCLOSE_M{};
    IEC_TIME CFGTIMEOUTCLIMB = 120000000000LL;
    IEC_TIME CFGTIMEOUTHOMEAXES = 60000000000LL;
    IEC_BOOL INITIALIZED = false;
};

using IEC_ST_FBMACHINEHOMINGCYCLE_CFG = ST_FBMACHINEHOMINGCYCLE_CFG;
...
public:
    ...
    IEC_BOOL WINCHESMECHANICALLYSTOPPED;
    ST_FBMACHINEHOMINGCYCLE_AXISHOMINGSTATUS M1STATUS;
    ST_FBMACHINEHOMINGCYCLE_AXISHOMINGSTATUS M2STATUS;
    IEC_BOOL BUCKETOFFSETVALID;
    IEC_BOOL DEADMANARMED;
    IEC_BOOL JOYSTICKDEFLECTED;
    IEC_BOOL JOYSTICKPULL;
    IEC_BOOL JOYSTICKPUSH;
    IEC_BOOL BTNVALIDATION;
    IEC_BOOL STARTREQUEST;
    ...
    IEC_E_MACHINEHOMINGSTEP MACHINEHOMINGSTEP;
    IEC_E_MACHINEHOMINGSTEP MACHINEHOMINGSTEPATERROR;
    IEC_E_MACHINEHOMINGTXSTATE MACHINEHOMINGSEQSTEP;
    ...
    ST_FBMACHINEHOMINGCYCLE_HOMINGDEMAND M1DEMAND;
    ST_FBMACHINEHOMINGCYCLE_HOMINGDEMAND M2DEMAND;
    ST_PROGRAMWINCHREQUEST CMDWINCHM1;
    ST_PROGRAMWINCHREQUEST CMDWINCHM2;
    IEC_BOOL CMDBUCKETOPEN;
    IEC_BOOL CMDBUCKETCLOSE;
    ST_FBMACHINEHOMINGCYCLE_BUCKETCOMMIT BUCKETCOMMIT;
    IEC_BOOL M3LOCKED;
    // Local variables
    ...
    IEC_E_MACHINEHOMINGTXSTATE SEQSTEP;
    IEC_BOOL PENDINGCLOSE;
    IEC_BOOL COMMITPUBLISHED;
    IEC_BOOL COMMITDONE;
    IEC_BOOL CYCLERUNNING;
    IEC_BOOL HOMEREQDONE;
    IEC_BOOL SEENNEUTRAL;
    TON CLIMBTIMER;
    TON HOMEAXESTIMER;
    TON SETTLEGRACETIMER;
    TON AUTOARMTIMER;
    IEC_BOOL FIRSTSCANDONE;
    R_TRIG VALIDATIONBTNEDGER;
    F_TRIG VALIDATIONBTNEDGEF;
    R_TRIG STARTEDGE;
    R_TRIG FORCESTEPAPPLYEDGE;
    IEC_INT FORCESTEPCLAMPED;
    TON VALIDATIONHOLDTIMER;
    TON VALIDATIONGAPTIMER;
    IEC_INT VALIDATIONPRESSCOUNT;
    IEC_BOOL VALIDATIONHELDOK;
    IEC_BOOL EXPLICITVALIDATIONPULSE;
    IEC_BOOL BOTHAXESHOMED;
    IEC_BOOL COMMITOROFFSETVALID;
    IEC_BOOL CLIMBPERMIT;
    IEC_BOOL DESCENDPERMIT;
    IEC_BOOL BUCKETPERMIT;
    IEC_BOOL ISINMOVEPHASE;
    IEC_BOOL AXISHOMINGERROR;
    IEC_BOOL MOTIONOUTOFPHASE;
    IEC_BOOL MODELOSTDURINGCYCLE;
    IEC_BOOL AUTOARMCANDIDATE;
    IEC_BOOL CLIMBTIMEDOUT;
    IEC_BOOL HOMEAXESTIMEDOUT;
    IEC_BOOL TRANSACTIONABORT;
    IEC_BOOL REHOMINGACKREQUIRED;
    IEC_BOOL MACHINEWASHOMED;
    IEC_BOOL HOMINGLOSSLATCHED;
    IEC_BOOL MACHINEHOMEDRAW;
    IEC_BOOL AXESDATUMRAW;
    // Local variables
    IEC_INT CST_CAUSEHOMINGLOSTINMOTION;
    IEC_INT CST_CAUSECLIMBTIMEOUT;
    IEC_INT CST_CAUSEMOTIONOUTOFPHASE;
    IEC_INT CST_CAUSEHOMINGERRORM1;
    IEC_INT CST_CAUSEHOMINGERRORM2;
    IEC_INT CST_CAUSEHOMEAXESTIMEOUT;
    IEC_TIME CST_VALIDATIONHOLD;
    IEC_TIME CST_VALIDATIONPRESSHOLD;
    IEC_TIME CST_VALIDATIONGAP;
    IEC_INT CST_VALIDATIONCOUNT;
    IEC_TIME CST_SETTLEGRACE;
    ...
    virtual ~FB_CYCLEMACHINEHOMING() = default;
