...
> de la chaîne de coupure de puissance. Voir `DOC/AF_Partie-09_Fonction_Winch_v1.9.md` §4quinquies
...
> technique complet en `DOC/AF_Partie-09_Fonction_Winch_v1.9.md` §4quinquies, non re-décrit ici).
