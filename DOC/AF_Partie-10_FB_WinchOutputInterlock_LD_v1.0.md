...
> Source code : `CODE/TREUILS/FB_WinchOutputInterlock_LD.st` · instances dans `PRG_10_Outputs_LD`.
...
2 instances : `instWinchOutputInterlockM1_LD`, `instWinchOutputInterlockM2_LD`, dans `PRG_10_Outputs_LD`.
