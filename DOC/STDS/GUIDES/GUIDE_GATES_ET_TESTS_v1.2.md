...
- `ARCHIVES/Doc/AUDITS/RAPPORT_LINTER_ET_WORKFLOW_CODESYS.md` — rapport d'origine ayant introduit `CODE_XML/`, `test_codesys_compile.py`, `codesys_compilation_diag.py`.
