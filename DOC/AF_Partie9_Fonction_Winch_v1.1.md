...
sont codées depuis le 2026-07-02 (voir `DOC/AF_Partie10_Fonction_Encoder_Homing_v1.4.md` §9), mais
...
- **Partie 10 v1.4** — Encoder Homing (dépendance bloquante §9 ci-dessus, pas encore codée).
