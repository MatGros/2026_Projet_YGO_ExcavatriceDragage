...
> [P8 Joystick v1.2](AF_Partie8_Fonction_Joystick_v1.2.md), [P9 Winch v1.7](AF_Partie9_Fonction_Winch_v1.7.md),
...
Profil « brique réduite » ([Partie3 v1.3](AF_Partie3_Template_FB_Commun_v1.3.md) §1bis) : pas de contrat `Enable`/`Reset`/`Error` complet, pas
...
position cible en vue instance CODESYS (doc [Partie11 §9bis](AF_Partie11_Fonction_Chariot_v1.3.md)).
