# Fiche `FB_TroubleshootingView` v1.0
...
| `SimulationModeActive`, `SimWinchActive`, `SimTranslationActive`, `SimOperatorActive`, `SimMachineActive` | `BOOL` | Contexte simulation (`GVL_Simulation`) |
...
| TC-P14-TSV-04 | `check_linkage.py` : instance unique, appelée dans `PRG_07_Supervision` seul | `check_linkage.py --report` |
