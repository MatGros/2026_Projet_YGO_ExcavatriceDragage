...
> Source : `CODE/H_TREUILS_BENNE/FB_Winch_Symmetry.st` · instance : `PRG_07_Supervision.instWinchSymmetry`.
...
| `M1/M2CommandActive` | BOOL | `PRG_04_Treuils_Benne` |
| `M1/M2Direction` | INT | `PRG_04_Treuils_Benne` |
