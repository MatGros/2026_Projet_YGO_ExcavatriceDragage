...
| 🕹️ Joystick | `SimJoystickLeft_Rev_TREMIE_Active`, `SimJoystickRight_Fwd_MAINT_Active`, `SimJoystickFwd_Up_Close_Active`, `SimJoystickRev_Down_Open_Active` | Un seul bouton impose `0`/`5000`/`10000` (plusieurs ⇒ neutre). **Auto-armement inclus** : l'activation d'un bouton directionnel simule automatiquement l'appui homme-mort `JoyBtnRaw` pour fluidifier les essais sur banc. |
