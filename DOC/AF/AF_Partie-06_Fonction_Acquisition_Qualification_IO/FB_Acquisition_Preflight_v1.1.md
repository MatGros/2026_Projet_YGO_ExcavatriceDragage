...
> Source : `CODE/COMMUN/FB_Acquisition_Preflight.st` · instance : `PRG_TROUBLESHOOTING_CFC.instPreflight` (ST actuel) ; cible `PRG_07_Supervision_CFC`, qui absorbe le troubleshooting en lecture seule stricte.
