# Fiche `FB_Input` — v1.2 — composant en retrait contrôlé
...
> Rôle machine : [`AF_Partie-06_Acquisition_Qualification_IO_v2.4.md`](../AF_Partie-06_Acquisition_Qualification_IO_v2.4.md) §3 (frontière unique) / §9 (TBD `FB_Input.ChannelOk`).
...
|---|---|---|
| v1.2 | 2026-08-26 | Ajout du lien explicite vers le chapô AF-06 (rôle machine + TBD associé) |
