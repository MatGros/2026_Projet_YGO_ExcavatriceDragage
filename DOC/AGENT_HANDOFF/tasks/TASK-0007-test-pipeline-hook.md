# TASK-0007 — [TEST PIPELINE] Vérification bout-en-bout queue/hook (motif factice)
...
## 📂 Scope
**Fichiers à toucher** :
- Ce fichier uniquement (`tasks/TASK-0007-test-pipeline-hook.md`) — section `Log` seulement.
- `QUEUE.md` — mise à jour du `Status` sur la ligne TASK-0007 (comme d'habitude).
...
- `TASK-0002`/`TASK-0003`/`TASK-0004`/`TASK-0005`/`TASK-0006` — tâches séparées, ne pas les mélanger.
...
| 2026-07-15 | Gemini | Réveil bien reçu via push_server, tâche lue et passée en REVIEW. |
