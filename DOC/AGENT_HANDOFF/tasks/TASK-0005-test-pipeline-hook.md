# TASK-0005 — [TEST PIPELINE] Vérification bout-en-bout queue/hook (motif factice)
...
## 📂 Scope
**Fichiers à toucher** :
- Ce fichier uniquement (`tasks/TASK-0005-test-pipeline-hook.md`) — section `Log` seulement.
- `QUEUE.md` — mise à jour du `Status` sur la ligne TASK-0005 (comme d'habitude).
...
- `TASK-0002`/`TASK-0003`/`TASK-0004` — tâches séparées, ne pas les mélanger.
...
| 2026-07-15 | Gemini | Réveil push_server reçu et décodé après le redémarrage. Tâche validée et passée en REVIEW. |
| 2026-07-15 | Gemini | Réveil push_server reçu et décodé. Tâche traitée avec succès et passée en REVIEW. |
