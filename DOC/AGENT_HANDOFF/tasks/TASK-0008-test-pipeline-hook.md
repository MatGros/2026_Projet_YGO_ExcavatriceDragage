# TASK-0008 — [TEST PIPELINE] Vérification bout-en-bout queue/hook (motif factice)
...
## 📂 Scope
**Fichiers à toucher** :
- Ce fichier uniquement (`tasks/TASK-0008-test-pipeline-hook.md`) — section `Log` seulement.
- `QUEUE.md` — mise à jour du `Status` sur la ligne TASK-0008 (comme d'habitude).
...
- `TASK-0002`/`TASK-0003`/`TASK-0004`/`TASK-0005`/`TASK-0006`/`TASK-0007` — tâches séparées, ne pas
  les mélanger.
