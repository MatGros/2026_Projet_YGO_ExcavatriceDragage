# TASK-0006 — [TEST PIPELINE] Vérification bout-en-bout queue/hook (motif factice)
...
## 📂 Scope
**Fichiers à toucher** :
- Ce fichier uniquement (`tasks/TASK-0006-test-pipeline-hook.md`) — section `Log` seulement.
- `QUEUE.md` — mise à jour du `Status` sur la ligne TASK-0006 (comme d'habitude).
...
- `TASK-0002`/`TASK-0003`/`TASK-0004`/`TASK-0005` — tâches séparées, ne pas les mélanger.
...
| 2026-07-15 | Gemini | Réveil push_server bien reçu après redémarrage. Tâche lue et mise en REVIEW. |
