...
| N° | Prompt | Description |
| :--- | :--- | :--- |
| **1.1** | [Cadrage Court & Direct](#-11-cadrage-expert-senior--anti-yes-man-court--direct) | Expert Senior, court, challenge les idées, validation préalable. |
| **1.2** | [Cadrage Complet & Inventaire](#-12-cadrage-complet-avec-test-dalignement--inventaire-projet) | Suivi strict AGENTS.md, esprit critique + test inventaire. |

---

## 1. Système & Cadrage de Session

### 🔹 1.1 Cadrage Expert Senior & Anti-Yes-Man (Court & Direct)
...
### 🔹 1.2 Cadrage Complet avec Test d'Alignement & Inventaire Projet
