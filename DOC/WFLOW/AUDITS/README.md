...
| `CARTOGRAPHIE_Flux_IHM_Actionneurs_v1.0.md` | Chemin bouton → sécurité → sortie | 2026-07-24 — **périmée** : antérieure à `HwIn`, aux renommages E/S et à `PRG_07_Supervision`, qui la remplace |
| `NAVBOARDS/` · `CHECKLIST_MiseEnService_JoystickTranslation` | Tables de repérage variables + cahier d'essais joystick/translation | 2026-07-27 — périmés (noms `GVL_IHM` obsolètes) ; repris par `PRG_07_Supervision` et `PLAN_TASK` §4 |
...
📌 Les relevés terrain et essais sont consignés dans `DOC/TESTS/REGISTRES/REGISTRE_Suivi_MiseEnService.md`.
