...
| AF-14 | ✅ Fait | `85cee005` (+fix `f6df962c`) | 1 tour, PASS avec réserves — §5 invariant sur-généralisait au POU entier (corrigé, portée restreinte au FB), coquille `_IHM`→`_HMI` |
