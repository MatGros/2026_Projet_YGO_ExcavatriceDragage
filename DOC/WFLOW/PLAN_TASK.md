...
| T118 | 🟡 IHM : quand un mouvement est bloqué par un interlock, afficher la **cause + l'action à faire** (ex. descente bloquée par Dive + benne fermée → « Ouvrir la benne ») au lieu d'un simple « mouvement interdit » | Projet / IHM | `PRG_07_Supervision.st`, `FB_Hmi_BannerFormatter.st`, reliquat session 2026-08-16 — nécessite d'exposer la **cause du blocage** (pas seulement le bit permit) ; lié à T116 |
