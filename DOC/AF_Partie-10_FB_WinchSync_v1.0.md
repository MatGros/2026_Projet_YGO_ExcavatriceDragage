...
> Source code : `CODE/TREUILS/FB_WinchSync.st` · instance unique dans `PRG_06_WinchControl`.
...
| **1** (ce FB, bit1) | incohérence commande | 500ms | **Grave** — remonté SafeStop fast côté PRG_06 |
...
(pas d'attente du filtre 500/800ms interne) — câblé dans `PRG_06_WinchControl`, pas dans ce FB.
...
| Code | `CODE/TREUILS/FB_WinchSync.st`, `CODE/MAIN/PRG_06_WinchControl.st` |
