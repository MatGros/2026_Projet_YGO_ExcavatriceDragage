...
| T92 | 🟠 **Qualification des bypass ciblés et du homing à 0 m** (MES-002) : à valider — comportement de chaque bypass, **persistance après redémarrage** (ils sont RETAIN), homing M1/M2 à 0,0 m, cohérence de la position et réarmement sûr. ⚠️ Rappelé par la revue L3 : une invalidation RETAIN remet les bypass à `FALSE`, ce qui peut **faire réapparaître un blocage qu'un bypass masquait** | Terrain / Sécurité | `REGISTRE` MES-002 |
