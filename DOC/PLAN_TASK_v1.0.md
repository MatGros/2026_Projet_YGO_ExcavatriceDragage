...
| T65 | 🟡 Test PLC automatique écrit (`FB_SupervisionValidation.st`, TC-CP1..CP5), en attente d'exécution réelle CODESYS par l'utilisateur avant clôture C3/safety. | Projet | `CONFIG-PERSIST-01`, `PRG_09_Supervision.st` §2/§2bis/§3 |
