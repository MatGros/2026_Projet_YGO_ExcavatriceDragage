# 📋 Analyse Fonctionnelle — Partie 5 : Modes & Maintenance (v1.1)

> 🔧 **2026-07-02** — Terminologie : godet → grappin, `FB_Bucket` → `FB_Grappin`, `OverrideBucket` → `OverrideGrappin` (correction utilisateur).
