...
| [Sample CFC natif](../TOOLS/ST_PLCOPENXML_GENERATOR/samples_reference_codesys/PRG_CFC_3FB.xml) | Structure PLCopenXML exportée par CODESYS ; procédure normative dans AF_Partie-03 §5 |
...
| Décision d'architecture actée | [AUDITS/Architecture/RU_C4_ARCHITECTURE_PROCEDES.md](AUDITS/Architecture/RU_C4_ARCHITECTURE_PROCEDES.md) |
| Plan d'exécution de la migration | [AUDITS/Architecture/PLAN_EXECUTION_MIGRATION_7POU.md](AUDITS/Architecture/PLAN_EXECUTION_MIGRATION_7POU.md) |
