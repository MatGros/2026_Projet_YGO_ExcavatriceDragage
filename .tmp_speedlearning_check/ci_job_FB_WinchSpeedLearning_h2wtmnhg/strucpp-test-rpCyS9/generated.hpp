...
struct ST_FBWINCHSPEEDLEARNING_CELL {
    IEC_BOOL VALID{};
    IEC_REAL SPEEDMPS{};
    IEC_UDINT SAMPLECOUNT{};
};

using IEC_ST_FBWINCHSPEEDLEARNING_CELL = ST_FBWINCHSPEEDLEARNING_CELL;

struct ST_FBWINCHSPEEDLEARNING_TABLE {
    Array1D<Array1D<Array1D<Array1D<ST_FBWINCHSPEEDLEARNING_CELL, 1, 5>, 1, 2>, 1, 2>, 1, 2> CELL{};
};

using IEC_ST_FBWINCHSPEEDLEARNING_TABLE = ST_FBWINCHSPEEDLEARNING_TABLE;

struct ST_FBWINCHSPEEDLEARNING_CFG {
    Array1D<IEC_REAL, 1, 5> MINSPEEDMPS{};
    Array1D<IEC_REAL, 1, 5> MAXSPEEDMPS{};
    IEC_UDINT MINSAMPLES{};
};

using IEC_ST_FBWINCHSPEEDLEARNING_CFG = ST_FBWINCHSPEEDLEARNING_CFG;
...
public:
    ...
    IEC_BOOL LOADPRESENT;
    IEC_BOOL STABLEFORLEARN;
    ST_FBWINCHSPEEDLEARNING_CFG CONFIG;
    // Outputs
    IEC_BOOL READY;
    IEC_BOOL LEARNING;
    IEC_BOOL TABLECOMPLETE;
    IEC_BOOL LAMPLEARN;
    IEC_INT CELLSFILLED;
    IEC_INT CELLSTOTAL;
    // In-Out
    ...
    // Local variables
    IEC_BOOL LEARNREQUESTED;
    IEC_BOOL MEASUREUSABLE;
    IEC_BOOL SENSACTIVE;
    IEC_BOOL STEPINRANGE;
    IEC_BOOL AXEINRANGE;
    IEC_BOOL CONTEXTVALID;
    IEC_BOOL COLLECTALLOWED;
    IEC_BOOL SPEEDPLAUSIBLE;
    IEC_INT SENSIDX;
    IEC_INT CHARGEIDX;
    ST_FBWINCHSPEEDLEARNING_CELL CURRENTCELL;
    IEC_INT AXEIDX;
    IEC_INT SENSLOOPIDX;
    IEC_INT CHARGELOOPIDX;
    IEC_INT PALIERIDX;
    // Local variables
    IEC_INT CST_AXECOUNT;
    IEC_INT CST_SENSCOUNT;
    IEC_INT CST_CHARGECOUNT;
    IEC_INT CST_PALIERCOUNT;
    IEC_INT CST_IDXMONTEE;
    IEC_INT CST_IDXDESCENTE;
    IEC_INT CST_IDXVIDE;
    IEC_INT CST_IDXCHARGE;

    // Implicit IEC 61131-3 ENO pin (mirrors EN)
    IEC_BOOL ENO = true;

    // Constructor
    FB_WINCHSPEEDLEARNING();

    // Execute function block
    void operator()();

    virtual ~FB_WINCHSPEEDLEARNING() = default;
