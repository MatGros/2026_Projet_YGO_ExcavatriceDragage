...
- **[Partie 6](DOC/AF_Partie-06_IO_Conditioning_v1.7.md)** — Conditionnement E/S (`FB_Input_Digital`, `FB_Output_Relay`).
...
- [AF_Partie-13_Fonction_Simulation_v2.0.md](DOC/AF_Partie-13_Fonction_Simulation_v2.0.md) — Fonction Simulation (flags bits maître + granularité par device)
