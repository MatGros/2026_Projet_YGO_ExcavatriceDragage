...
static std::string __trace_fields(const strucpp::FB_MACHINEHOMINGCYCLE& fb) {
    return "\"ENABLE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.ENABLE)) + "\"" + "," + "\"RESET\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.RESET)) + "\"" + "," + "\"MODE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.MODE)) + "\"" + "," + "\"TOPPOSITIONACTIVE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.TOPPOSITIONACTIVE)) + "\"" + "," + "\"WINCHESMECHANICALLYSTOPPED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.WINCHESMECHANICALLYSTOPPED)) + "\"" + "," + "\"M1STATUS.HOMEDANDRELIABLE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M1STATUS.HOMEDANDRELIABLE)) + "\"" + "," + "\"M1STATUS.HOMINGBUSY\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M1STATUS.HOMINGBUSY)) + "\"" + "," + "\"M1STATUS.HOMINGDONE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M1STATUS.HOMINGDONE)) + "\"" + "," + "\"M1STATUS.HOMINGERROR\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M1STATUS.HOMINGERROR)) + "\"" + "," + "\"M2STATUS.HOMEDANDRELIABLE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M2STATUS.HOMEDANDRELIABLE)) + "\"" + "," + "\"M2STATUS.HOMINGBUSY\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M2STATUS.HOMINGBUSY)) + "\"" + "," + "\"M2STATUS.HOMINGDONE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M2STATUS.HOMINGDONE)) + "\"" + "," + "\"M2STATUS.HOMINGERROR\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M2STATUS.HOMINGERROR)) + "\"" + "," + "\"BUCKETOFFSETVALID\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.BUCKETOFFSETVALID)) + "\"" + "," + "\"CONFIRMOPENPOSITION\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CONFIRMOPENPOSITION)) + "\"" + "," + "\"CONFIRMCLOSEPOSITION\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CONFIRMCLOSEPOSITION)) + "\"" + "," + "\"CFGTOPHOMINGTARGETM\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CFGTOPHOMINGTARGETM)) + "\"" + "," + "\"CFGOFFSETOPENM\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CFGOFFSETOPENM)) + "\"" + "," + "\"CFGOFFSETCLOSEM\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CFGOFFSETCLOSEM)) + "\"" + "," + "\"READY\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.READY)) + "\"" + "," + "\"FAULT.ERROR\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.FAULT.ERROR)) + "\"" + "," + "\"FAULT.ERRORID\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.FAULT.ERRORID)) + "\"" + "," + "\"FAULT.LATCHED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.FAULT.LATCHED)) + "\"" + "," + "\"FAULT.LATCHEDID\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.FAULT.LATCHEDID)) + "\"" + "," + "\"LIFECYCLE.BUSY\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.LIFECYCLE.BUSY)) + "\"" + "," + "\"LIFECYCLE.DONE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.LIFECYCLE.DONE)) + "\"" + "," + "\"MACHINEHOMED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.MACHINEHOMED)) + "\"" + "," + "\"MACHINEHOMINGSTEP\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.MACHINEHOMINGSTEP)) + "\"" + "," + "\"MACHINEHOMINGSTEPATERROR\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.MACHINEHOMINGSTEPATERROR)) + "\"" + "," + "\"MACHINEHOMINGACTIVE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.MACHINEHOMINGACTIVE)) + "\"" + "," + "\"MACHINEHOMINGLOSSSAFESTOP\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.MACHINEHOMINGLOSSSAFESTOP)) + "\"" + "," + "\"MACHINEHOMINGFAILED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.MACHINEHOMINGFAILED)) + "\"" + "," + "\"M1DEMAND.HOMEREQ\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M1DEMAND.HOMEREQ)) + "\"" + "," + "\"M1DEMAND.USEDYNAMICTARGET\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M1DEMAND.USEDYNAMICTARGET)) + "\"" + "," + "\"M1DEMAND.DYNAMICTARGET_M\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M1DEMAND.DYNAMICTARGET_M)) + "\"" + "," + "\"M2DEMAND.HOMEREQ\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M2DEMAND.HOMEREQ)) + "\"" + "," + "\"M2DEMAND.USEDYNAMICTARGET\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M2DEMAND.USEDYNAMICTARGET)) + "\"" + "," + "\"M2DEMAND.DYNAMICTARGET_M\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.M2DEMAND.DYNAMICTARGET_M)) + "\"" + "," + "\"BUCKETCOMMIT.COMMITOPEN\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.BUCKETCOMMIT.COMMITOPEN)) + "\"" + "," + "\"BUCKETCOMMIT.COMMITCLOSE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.BUCKETCOMMIT.COMMITCLOSE)) + "\"" + "," + "\"PENDINGOPEN\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.PENDINGOPEN)) + "\"" + "," + "\"PENDINGCLOSE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.PENDINGCLOSE)) + "\"" + "," + "\"HOMINGSTARTED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.HOMINGSTARTED)) + "\"" + "," + "\"HOMINGBUSYOBSERVED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.HOMINGBUSYOBSERVED)) + "\"" + "," + "\"COMMITPUBLISHED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.COMMITPUBLISHED)) + "\"" + "," + "\"MACHINEWASHOMED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.MACHINEWASHOMED)) + "\"" + "," + "\"HOMINGLOSSLATCHED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.HOMINGLOSSLATCHED)) + "\"" + "," + "\"REHOMINGACKREQUIRED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.REHOMINGACKREQUIRED)) + "\"" + "," + "\"DOUBLECONFIRMREQUESTED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.DOUBLECONFIRMREQUESTED)) + "\"" + "," + "\"SINGLECONFIRM\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.SINGLECONFIRM)) + "\"" + "," + "\"CONFIRMWHILEHOMING\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CONFIRMWHILEHOMING)) + "\"" + "," + "\"WINDOWSAFE\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.WINDOWSAFE)) + "\"" + "," + "\"AXISHOMED\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.AXISHOMED)) + "\"" + "," + "\"COMMITOROFFSETVALID\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.COMMITOROFFSETVALID)) + "\"" + "," + "\"TRANSACTIONABORT\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.TRANSACTIONABORT)) + "\"" + "," + "\"MACHINEHOMEDRAW\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.MACHINEHOMEDRAW)) + "\"" + "," + "\"CAUSE_HOMING_LOST_IN_MOTION\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CAUSE_HOMING_LOST_IN_MOTION)) + "\"" + "," + "\"CAUSE_TX_ABORT_TOP_LOST\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CAUSE_TX_ABORT_TOP_LOST)) + "\"" + "," + "\"CAUSE_TX_ABORT_MOTION\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CAUSE_TX_ABORT_MOTION)) + "\"" + "," + "\"CAUSE_HOMING_ERROR_M1\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CAUSE_HOMING_ERROR_M1)) + "\"" + "," + "\"CAUSE_HOMING_ERROR_M2\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CAUSE_HOMING_ERROR_M2)) + "\"" + "," + "\"CAUSE_DOUBLE_CONFIRM\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CAUSE_DOUBLE_CONFIRM)) + "\"" + "," + "\"CAUSE_CONFIRM_WHILE_HOMING\":\"" + strucpp::json_escape(strucpp::to_display_string(fb.CAUSE_CONFIRM_WHILE_HOMING)) + "\"";
}
...
bool test_1(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-001 : machine non qualifiee avec 2 codeurs seuls (offset benne absent)";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
...
bool test_2(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-010 : M1 non reference => M1_NOT_HOMED";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
...
bool test_3(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-011 : M2 non reference => M2_NOT_HOMED";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_4(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-012 : les deux non references => BOTH_NOT_HOMED";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_5(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-020 : codeurs OK, offset absent, N2 sans capteur haut => NEED_TOP_POSITION";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = false;
...
bool test_6(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-021 : capteur haut atteint mais treuils non arretes => NEED_MECHANICAL_STOP";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_7(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-022 : fenetre sure => AWAIT_BUCKET_CONFIRM";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_8(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-030 : confirmation refusee hors MAINT_N2";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
...
bool test_9(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-031 : confirmation fermee admissible => homing M1+M2, cible M2 = top + offset ferme, commit atomique";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_10(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-040 : abandon si capteur haut perdu pendant la transaction";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_11(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-041 : abandon si erreur homing M1 pendant la transaction";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_12(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-042 : abandon si mouvement pendant la transaction";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_13(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-050 : Confirm ouverte ET fermee au meme scan => aucune transaction + cause latchee";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_14(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-060 : confirmation ignoree si un homing d axe est deja Busy";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_15(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-070 : perte reference en mouvement => SafeStop, puis pas de requalification auto";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_16(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-080 : Enable FALSE en pleine transaction => retour IDLE, sorties sures";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
...
bool test_17(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-090 : aucune confirmation explicite => aucun commit benne";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
        ...
        s.FB.ENO = true;
        printf("SCANTRACE {\"test\":\"%s\",\"scan\":%d,\"t_ns\":%lld,\"fields\":{%s}}\n", __test_name, __scan_id++, (long long)strucpp::__CURRENT_TIME_NS, __trace_fields(s.FB).c_str());
        if (!ctx.assert_false(static_cast<bool>(s.FB.BUCKETCOMMIT.COMMITOPEN), "FB.BUCKETCOMMIT.COMMITOPEN", 268, "Presel. fermee IHM ne vaut pas confirmation")) return false;
        if (!ctx.assert_false(static_cast<bool>(s.FB.BUCKETCOMMIT.COMMITCLOSE), "FB.BUCKETCOMMIT.COMMITCLOSE", 269, "Aucun commit sans front operateur")) return false;
        return true;
    }();
    s.teardown();
    return __passed;
...
bool test_18(strucpp::TestContext& ctx) {
    ...
    s.setup();
    bool __passed = [&]() -> bool {
        __scan_id = 0; const char* __test_name = "TC-T185-091 : confirmation ouverte explicite => chemin ouvert exclusif";
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        s.FB.TOPPOSITIONACTIVE = true;
        ...
        s.FB.ENO = true;
        printf("SCANTRACE {\"test\":\"%s\",\"scan\":%d,\"t_ns\":%lld,\"fields\":{%s}}\n", __test_name, __scan_id++, (long long)strucpp::__CURRENT_TIME_NS, __trace_fields(s.FB).c_str());
        if (!ctx.assert_true(static_cast<bool>(s.FB.M1DEMAND.HOMEREQ), "FB.M1DEMAND.HOMEREQ", 284, "Confirmation ouverte declenche M1")) return false;
        if (!ctx.assert_true(static_cast<bool>(s.FB.M2DEMAND.HOMEREQ), "FB.M2DEMAND.HOMEREQ", 285, "Confirmation ouverte declenche M2")) return false;
        strucpp::__CURRENT_TIME_NS += static_cast<int64_t>(10000000);
        s.FB.ENABLE = true;
        s.FB.RESET = false;
        s.FB.MODE = E_MODE::MAINT_N2;
        ...
        s.FB.ENO = true;
        printf("SCANTRACE {\"test\":\"%s\",\"scan\":%d,\"t_ns\":%lld,\"fields\":{%s}}\n", __test_name, __scan_id++, (long long)strucpp::__CURRENT_TIME_NS, __trace_fields(s.FB).c_str());
        if (!ctx.assert_true(static_cast<bool>(s.FB.BUCKETCOMMIT.COMMITOPEN), "FB.BUCKETCOMMIT.COMMITOPEN", 296, "Commit ouvert apres deux succes")) return false;
        if (!ctx.assert_false(static_cast<bool>(s.FB.BUCKETCOMMIT.COMMITCLOSE), "FB.BUCKETCOMMIT.COMMITCLOSE", 297, "Commit ferme exclusif")) return false;
        return true;
    }();
    s.teardown();
    return __passed;
...
int main(int argc, char* argv[]) {
    ...
    runner.add("TC-T185-090 : aucune confirmation explicite => aucun commit benne", test_17);
    runner.add("TC-T185-091 : confirmation ouverte explicite => chemin ouvert exclusif", test_18);
    return runner.run();
}
