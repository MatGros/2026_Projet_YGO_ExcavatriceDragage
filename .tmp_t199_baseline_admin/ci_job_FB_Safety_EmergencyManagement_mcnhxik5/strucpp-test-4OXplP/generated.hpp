...
struct ST_SAFETY_EMERGENCY_CMD {
    ...
    IEC_BOOL TESTCUTACTIVE{};
};

using IEC_ST_SAFETY_EMERGENCY_CMD = ST_SAFETY_EMERGENCY_CMD;

// Global variables
const inline IEC_INT CST_STEP_IDLE = 0;
const inline IEC_INT CST_STEP_TEST_A = 1;
const inline IEC_INT CST_STEP_RESTORE_A = 2;
const inline IEC_INT CST_STEP_TEST_B = 3;
const inline IEC_INT CST_STEP_RESTORE_B = 4;
const inline IEC_INT CST_STEP_PULSE = 5;
const inline IEC_INT CST_STEP_CONFIRM = 6;
const inline IEC_INT CST_ABORT_NONE = 0;
const inline IEC_INT CST_ABORT_CUT_IHM = 1;
const inline IEC_INT CST_ABORT_CHAIN_DROP = 2;
const inline IEC_INT CST_ABORT_TIMEOUT_RESTORE_A = 4;
const inline IEC_INT CST_ABORT_TIMEOUT_RESTORE_B = 8;
const inline IEC_INT CST_ABORT_POWER_CUTOFF = 16;
const inline IEC_INT CST_ABORT_REDUNDANCY_A = 32;
const inline IEC_INT CST_ABORT_REDUNDANCY_B = 64;
const inline IEC_INT CST_ABORT_TIMEOUT_CONTACTOR = 128;
const inline IEC_INT CST_ABORT_INVALID_STEP = 256;
...
public:
    ...
    IEC_INT LASTABORTSTEP;
    IEC_WORD LASTABORTCAUSE;
    IEC_BOOL ARMABLE_CHAINOK;
    IEC_BOOL ARMABLE_IDLE;
    IEC_BOOL ARMABLE_NOBLOCK;
    IEC_BOOL MAINTAIN_CHAINOK;
    IEC_BOOL MAINTAIN_NOCUTOFF;
    IEC_BOOL MAINTAINA_NOFAULT;
    IEC_BOOL MAINTAINB_NOFAULT;
    IEC_BOOL MAINTAINA_NOBLOCK;
    IEC_BOOL MAINTAINB_NOBLOCK;
    TON TONTESTA;
    TON TONRESTOREA;
    TON TONTESTB;
    TON TONRESTOREB;
