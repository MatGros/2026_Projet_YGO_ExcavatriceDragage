...
Chaîne de fraîcheur imposée (T171-B) :
    1. python TOOLS/TEST_AUTO_CI/scripts/generate_trace_cycle.py     # trace fraîche
    2. python TOOLS/TEST_AUTO_CI/scripts/embed_trace_in_animation.py # ré-embed
    3. python TOOLS/TEST_AUTO_CI/scripts/guard_animation_no_business_logic.py  # certification

Usage :
    python TOOLS/TEST_AUTO_CI/scripts/embed_trace_in_animation.py
    python TOOLS/TEST_AUTO_CI/scripts/embed_trace_in_animation.py --check  # 0 si déjà à jour
"""
