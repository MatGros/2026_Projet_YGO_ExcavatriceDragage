...
const KEYWORDS = new Set([
  ...
  "Calib","_CalibM1","Measurement","CablePosM",
  "EncoderIncoherent","M1_EncoderFault","EncoderFault",
  "M1_HomedAndReliable","HomedAndReliable","Speed_Mps",
  "SignedSpeed_Mps","SpeedValid",
  ...
  "M2_EncoderFault","M2_HomedAndReliable",
  "COD2_PresettTrigCmd",
