...
PLANS: list[tuple[str, str, str, list[str]]] = [
    ...
    ("C", "460", "G460 — Tests CI TEST_AUTO_CI (harnais STruCpp + négatifs + garde animation/fraîcheur, REX 2026-08-28)", [sys.executable, "TOOLS/TEST_AUTO_CI/scripts/run_ci_gates.py"]),
