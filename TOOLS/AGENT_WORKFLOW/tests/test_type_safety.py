"""Test de non-régression pour G330_check_type_safety.py (détection statique des erreurs de type CODESYS)."""
...
from G330_check_type_safety import check_type_safety
