...
- `ST_PLCOPENXML_GENERATOR` reste autonome ; le workflow peut l'appeler pour générer le bundle `CODE_XML/CODE_Bundle.xml` à partir des sources ST et des POU XML natifs/CFC présents dans `CODE/`.
