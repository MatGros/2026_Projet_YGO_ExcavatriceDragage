...
void FB_WINCH::operator()() {
    ...
    if (SPEEDGUARDENABLE) {
        ...
        } else if ((((MEASUREDSPEEDBAND >= 1)) & ((MEASUREDSPEEDBAND <= 5))) & ((REQUESTEDSTEP > MEASUREDSPEEDBAND))) {
