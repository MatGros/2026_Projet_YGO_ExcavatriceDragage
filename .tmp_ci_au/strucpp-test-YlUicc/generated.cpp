...
void FB_SAFETY_EMERGENCYMANAGEMENT::operator()() {
    ...
    if (!ENABLE) {
        ...
        if (!STARTUPCHECKDONE) {
            STARTUPCHECKOK = ((EMERGENCYCHAINCLOSED) & (!POWERCONTACTORENGAGED)) & ((ARMINGSEQSTEP == 0));
        ...
        if (ARMINGSEQSTEP != 0) {
            if (BTNEMERGENCYCUTOFF) {
                ...
                LASTABORTCAUSE = 0x0001;
                ARMINGSEQSTEP = 0;
            } else if (POWERCUTOFFREQUEST) {
                EMERGENCYARMINGLOCKOUTACTIVE = true;
                LASTABORTSTEP = ARMINGSEQSTEP;
                LASTABORTCAUSE = 0x0010;
                ARMINGSEQSTEP = 0;
            } else if ((((ARMINGSEQSTEP == 5) | (ARMINGSEQSTEP == 6))) & (!EMERGENCYCHAINCLOSED)) {
                EMERGENCYARMINGFAILEDCAUSE = true;
                EMERGENCYARMINGLOCKOUTACTIVE = true;
                LASTABORTSTEP = ARMINGSEQSTEP;
                LASTABORTCAUSE = 0x0002;
                ARMINGSEQSTEP = 0;
            }
        }
        if (((((((ARMREQEDGE.Q) & ((ARMINGSEQSTEP == 0))) & (EMERGENCYCHAINCLOSED)) & (!BTNEMERGENCYCUTOFF)) & (!POWERCUTOFFREQUEST)) & (!EMERGENCYARMINGLOCKOUTACTIVE)) & (!POWERCONTACTORENGAGED)) {
            ARMINGSEQSTEP = 1;
            REDUNDANCYTESTFAILEDCAUSE = false;
            EMERGENCYARMINGFAILEDCAUSE = false;
        }
        TONTESTA.IN = (ARMINGSEQSTEP == 1);
        ...
        TONRESTOREA.IN = (ARMINGSEQSTEP == 2);
        TONRESTOREA.PT = CST_TESTDURATION;
        TONRESTOREA();
        TONRESTOREA.ENO = true;
        if (((ARMINGSEQSTEP == 2)) & (TONRESTOREA.Q)) {
            if (EMERGENCYCHAINCLOSED) {
                ARMINGSEQSTEP = 3;
            } else {
                LASTABORTSTEP = 2;
                LASTABORTCAUSE = 0x0004;
                ARMINGSEQSTEP = 0;
            }
        }
        TONTESTB.IN = (ARMINGSEQSTEP == 3);
        ...
        TONRESTOREB.IN = (ARMINGSEQSTEP == 4);
        TONRESTOREB.PT = CST_TESTDURATION;
        TONRESTOREB();
        TONRESTOREB.ENO = true;
        if (((ARMINGSEQSTEP == 4)) & (TONRESTOREB.Q)) {
            if (EMERGENCYCHAINCLOSED) {
                ARMINGSEQSTEP = 5;
            } else {
                LASTABORTSTEP = 4;
                LASTABORTCAUSE = 0x0008;
                ARMINGSEQSTEP = 0;
            }
        }
        TONARMINGPULSE.IN = (ARMINGSEQSTEP == 5);
        TONARMINGPULSE.PT = CST_ARMINGPULSEDURATION;
        TONARMINGPULSE();
        TONARMINGPULSE.ENO = true;
        if (((ARMINGSEQSTEP == 5)) & (TONARMINGPULSE.Q)) {
            ARMINGSEQSTEP = 6;
        }
        TONARMINGCONFIRM.IN = (ARMINGSEQSTEP == 6);
        ...
        ARMABLE = ((((((EMERGENCYCHAINCLOSED) & (!BTNEMERGENCYCUTOFF)) & (!POWERCUTOFFREQUEST)) & ((ARMINGSEQSTEP == 0))) & (!EMERGENCYARMINGLOCKOUTACTIVE)) & (!REDUNDANCYTESTFAILEDCAUSE)) & (!POWERCONTACTORENGAGED);
        ARMINGBUSY = ((ARMINGSEQSTEP != 0)) | (EMERGENCYARMINGLOCKOUTACTIVE);
    ...
    CMD.MAINTAINA_CMD = (((((ENABLE) & (((EMERGENCYCHAINCLOSED) | ((ARMINGSEQSTEP != 0))))) & (!POWERCUTOFFREQUEST)) & (!FORCETESTA)) & (!BTNEMERGENCYCUTOFF)) & (!REDUNDANCYTESTFAILEDCAUSE);
    CMD.MAINTAINB_CMD = (((((ENABLE) & (((EMERGENCYCHAINCLOSED) | ((ARMINGSEQSTEP != 0))))) & (!POWERCUTOFFREQUEST)) & (!FORCETESTB)) & (!BTNEMERGENCYCUTOFF)) & (!REDUNDANCYTESTFAILEDCAUSE);
    CMD.ARMPULSE_CMD = (((ENABLE) & ((ARMINGSEQSTEP == 5))) & (!BTNEMERGENCYCUTOFF)) & (!POWERCUTOFFREQUEST);
    ...
    STATUS.BUSY = ((ARMINGSEQSTEP != 0)) | (EMERGENCYARMINGLOCKOUTACTIVE);
