...
public:
    ...
    IEC_REAL CFGTOPHOMINGTARGETM;
    IEC_REAL CFGOFFSETOPENM;
    IEC_REAL CFGOFFSETCLOSEM;
    // Outputs
    IEC_BOOL READY;
    ST_FAULT FAULT;
    ...
    IEC_BOOL PENDINGOPEN;
    IEC_BOOL PENDINGCLOSE;
    IEC_BOOL HOMINGSTARTED;
    IEC_BOOL HOMINGBUSYOBSERVED;
    IEC_BOOL COMMITPUBLISHED;
    IEC_BOOL MACHINEWASHOMED;
    IEC_BOOL HOMINGLOSSLATCHED;
    IEC_BOOL REHOMINGACKREQUIRED;
    IEC_BOOL DOUBLECONFIRMREQUESTED;
    IEC_BOOL SINGLECONFIRM;
    IEC_BOOL CONFIRMWHILEHOMING;
    IEC_BOOL WINDOWSAFE;
    IEC_BOOL AXISHOMED;
    ...
    // Local variables
    IEC_INT CAUSE_HOMING_LOST_IN_MOTION;
    IEC_INT CAUSE_TX_ABORT_TOP_LOST;
    IEC_INT CAUSE_TX_ABORT_MOTION;
    IEC_INT CAUSE_HOMING_ERROR_M1;
    IEC_INT CAUSE_HOMING_ERROR_M2;
    IEC_INT CAUSE_DOUBLE_CONFIRM;
    IEC_INT CAUSE_CONFIRM_WHILE_HOMING;
    ...
    virtual ~FB_MACHINEHOMINGCYCLE() = default;
